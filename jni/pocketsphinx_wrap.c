...
SWIGEXPORT jlong JNICALL Java_com_midea_asr_PocketSphinxJNI_new_1Decoder_1_1SWIG_11(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
...
SWIGEXPORT void JNICALL Java_com_midea_asr_PocketSphinxJNI_delete_1Decoder(JNIEnv *jenv, jclass jcls, jlong jarg1) {
...
SWIGEXPORT jlong JNICALL Java_com_midea_asr_PocketSphinxJNI_Decoder_1defaultConfig(JNIEnv *jenv, jclass jcls) {
  jlong jresult = 0 ;
  Config *result = 0 ;
...
SWIGEXPORT void JNICALL Java_com_midea_asr_PocketSphinxJNI_Decoder_1startUtt(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  Decoder *arg1 = (Decoder *) 0 ;
  int *arg2 = (int *) 0 ;
...
SWIGEXPORT jint JNICALL Java_com_midea_asr_PocketSphinxJNI_Decoder_1processRaw(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jshortArray jarg2, jlong jarg3, jboolean jarg4, jboolean jarg5) {
  jint jresult = 0 ;
  Decoder *arg1 = (Decoder *) 0 ;
  int16 *arg2 = (int16 *) 0 ;
  size_t arg3 ;
...
SWIGEXPORT void JNICALL Java_com_midea_asr_PocketSphinxJNI_Decoder_1endUtt(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  Decoder *arg1 = (Decoder *) 0 ;
  int *arg2 = (int *) 0 ;
